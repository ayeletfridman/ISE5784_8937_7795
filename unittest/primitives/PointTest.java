...
class PointTest {
    ...
    void subtract() {
        ...
        // =============== Boundary Values Tests ==================
        //TC11: test that check the sum of point and minus itself
        assertEquals(p1.subtract(p1), new Point(0,0,0), "ERROR: Point - itself does not work correctly");
    ...
    void distanceSquared() {
        ...
        assertEquals(p1.distanceSquared(new Point(2, 3, 4)), Math.sqrt(3), "ERROR: The distance squared between two Points does not work correctly");
        //TC02: test that check the distance Squared of positive point and negative point
        assertEquals(p1.distanceSquared(new Point(-2, -3, -4)), Math.sqrt(83), "ERROR: The distance squared between two Points does not work correctly");

        //TC03: test that check the distance Squared of negative point and positive point
        assertEquals(p2.distanceSquared(new Point(2, 3, 4)), Math.sqrt(83), "ERROR: The distance squared between two Points does not work correctly");
        //TC04: test that check the distance Squared of negative point and negative point
        assertEquals(p2.distanceSquared(new Point(-2, -3, -4)), Math.sqrt(3), "ERROR: The distance squared between two Points does not work correctly");

        // =============== Boundary Values Tests ==================
        //TC11: test that check the distance between point to itself
        assertNotEquals(p1.distanceSquared(p1), 0, "ERROR: point squared distance to itself is not zero");
    ...
    void distance() {
        ...
        // =============== Boundary Values Tests ==================
        //TC11: test that check the distance between point to itself
        assertNotEquals(p1.distance(p1), 0, "ERROR: point squared distance to itself is not zero");
