...
public class LightsTests {
    ...
    void SphereMultiple() {
        Camera camera1 = Camera.getBuilder()
                ...
                .setVpDistance(1000)
                .setVpSize(200, 200)
                .setImageWriter(new ImageWriter("lightSphereMultiple", 500, 500))
                .setRayTracer(new SimpleRayTracer(scene1))
                .build();
    ...
    void trianglesMultiple() {
        Camera camera2 = Camera.getBuilder()
                ...
                .setVpDistance(1000)
                .setVpSize(200, 200)
                .setImageWriter(new ImageWriter("lightTrianglesMultiple", 500, 500))
                .setRayTracer(new SimpleRayTracer(scene2))
                .build();
        ...
        scene2.lights.add(new DirectionalLight(new Color(0, 300, 0), trianglesLightDirection));
        scene2.lights.add(new PointLight(new Color(300, 0, 0), new Point(40, -70, -100)).setKl(0.0005).setKq(0.0005));
        scene2.lights.add(new SpotLight(new Color(0, 0, 300), new Point(12, 0, 0), new Vector(0, -2, -1))
